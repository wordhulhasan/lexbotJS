...
(function() {
  ...
  // import * as AudioControl from "./control.js";
...
},{"./control.js":3,"./conversation.js":4,"./recorder.js":5,"./worker.js":6,"webworkify":1}],3:[function(require,module,exports){
(function () {
  'use strict';
  var rec = require('./recorder.js');
  var recorder, audioRecorder, checkAudioSupport, audioSupported, playbackSource, UNSUPPORTED = 'Audio is not supported.';
...
},{"./recorder.js":5}],4:[function(require,module,exports){
(function() {
  'use strict';
  var AudioControl = require('./control.js').audioControl;
...
},{"./control.js":3}],5:[function(require,module,exports){
 (function () {
  'use strict';
  var work = require('webworkify');
  var worker = work(require('./worker.js'));
...
},{"./worker.js":6,"webworkify":1}],6:[function(require,module,exports){
module.exports = function (self) {
  'use strict';
  var recLength = 0,
    recBuffer = [],
